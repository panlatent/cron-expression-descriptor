...
//            '5-10 30-35 10-12 * * *' => 'Seconds 5 through 10 past the minute, minutes 30 through 35 past the hour, between 10:00 AM and 12:00 PM',
//            '30 */5 * * * *' => 'At 30 seconds past the minute, every 05 minutes',
//            '0 30 10-13 ? * WED,FRI' => 'At 30 minutes past the hour, between 10:00 AM and 01:00 PM, only on Wednesday and Friday',
//            '10 0/5 * * * ?' => 'At 10 seconds past the minute, every 05 minutes',
//            '2-59/3 1,9,22 11-26 1-6 ?' => 'Every 03 minutes, minutes 2 through 59 past the hour, at 01:00 AM, 09:00 AM, and 10:00 PM, between day 11 and 26 of the month, January through June',
//            '0 0 6 1/1 * ?' => 'At 06:00 AM',
//            '0 5 0/1 * * ?' => 'At 05 minutes past the hour',
...
//            '23 12 * JAN-MAR * 2013-2015' => 'At 12:23 PM, January through March, 2013 through 2015',
        ...
        foreach ($rows as $expr => $expected) {
            $this->assertEquals($expected, (new ExpressionDescriptor($expr))->getDescription());
        }
    }
}
